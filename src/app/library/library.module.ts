...
@NgModule({
  ...
  declarations: [LibraryComponent, ViewReturnComponent, ViewBookComponent, ReportComponent, AddBookComponent, EditBookComponent, DetailComponent, AddCategoryComponent, BookReturnComponent, IssueBookComponent]
})
